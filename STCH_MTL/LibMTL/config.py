...
_parser.add_argument('--weighting', type=str, default='STCH',
    help='loss weighing strategies, option: EW, UW, GradNorm, GLS, RLW\
        MGDA, PCGrad, GradVac, CAGrad, GradDrop, DWA, IMTL, STCH')
...
_parser.add_argument('--weight_decay', type=float, default=1e-05, help='weight decay for all types of optim')
## scheduler
